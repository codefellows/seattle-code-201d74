...
// this is only for me to demonstrate inheritance... only do if there is time
// function Cat () {
//   this.genus = 'Felis'
//   this.family = 'Felidae';
// }
...
// tell Kitten to inherit from Cat if there is time
// Kitten.prototype = new Cat();

// same function from yesterday
...
// another way to do it... using a function as a value, not calling it
